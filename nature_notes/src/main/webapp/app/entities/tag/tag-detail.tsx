    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>{tagEntity.camping}</dd>
          <dt>
            <span id="hike">Hike</span>
          </dt>
          <dd>{tagEntity.hike}</dd>
          <dt>
            <span id="roadTrip">Road Trip</span>
          </dt>
          <dd>{tagEntity.roadTrip}</dd>
          <dt>
            <span id="international">International</span>
          </dt>
          <dd>{tagEntity.international}</dd>
          <dt>
            <span id="soloTravel">Solo Travel</span>
          </dt>
          <dd>{tagEntity.soloTravel}</dd>
        </dl>
