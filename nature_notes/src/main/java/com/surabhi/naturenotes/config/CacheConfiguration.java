package com.surabhi.naturenotes.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.surabhi.naturenotes.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.surabhi.naturenotes.repository.UserRepository.USERS_BY_EMAIL_CACHE);
