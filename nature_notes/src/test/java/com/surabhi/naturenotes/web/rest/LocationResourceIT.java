...
import com.surabhi.naturenotes.domain.Location;
import com.surabhi.naturenotes.repository.LocationRepository;
...
class LocationResourceIT {
    ...
    void createLocation() throws Exception {
        ...
        assertThat(testLocation.getLatLong()).isEqualTo(DEFAULT_LAT_LONG);
    }
    ...
    void getAllLocations() throws Exception {
        ...
        restLocationMockMvc
            ...
            .andExpect(jsonPath("$.[*].latLong").value(hasItem(DEFAULT_LAT_LONG)));
    }
    ...
    void getLocation() throws Exception {
        ...
        restLocationMockMvc
            ...
            .andExpect(jsonPath("$.latLong").value(DEFAULT_LAT_LONG));
    }
    ...
    void putExistingLocation() throws Exception {
        ...
        assertThat(testLocation.getLatLong()).isEqualTo(UPDATED_LAT_LONG);
    }
    ...
    void partialUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.locationName(UPDATED_LOCATION_NAME).city(UPDATED_CITY).state(UPDATED_STATE).latLong(UPDATED_LAT_LONG);
