...
import com.surabhi.naturenotes.repository.TagRepository;
...
class TagResourceIT {
    ...
    private static final String DEFAULT_HIKE = "AAAAAAAAAA";
    private static final String UPDATED_HIKE = "BBBBBBBBBB";

    private static final String DEFAULT_ROAD_TRIP = "AAAAAAAAAA";
    private static final String UPDATED_ROAD_TRIP = "BBBBBBBBBB";

    private static final String DEFAULT_INTERNATIONAL = "AAAAAAAAAA";
    private static final String UPDATED_INTERNATIONAL = "BBBBBBBBBB";

    private static final String DEFAULT_SOLO_TRAVEL = "AAAAAAAAAA";
    private static final String UPDATED_SOLO_TRAVEL = "BBBBBBBBBB";
    ...
    public static Tag createEntity(EntityManager em) {
        Tag tag = new Tag()
            ...
            .hike(DEFAULT_HIKE)
            .roadTrip(DEFAULT_ROAD_TRIP)
            .international(DEFAULT_INTERNATIONAL)
            .soloTravel(DEFAULT_SOLO_TRAVEL);
        return tag;
    }
    ...
    public static Tag createUpdatedEntity(EntityManager em) {
        Tag tag = new Tag()
            ...
            .hike(UPDATED_HIKE)
            .roadTrip(UPDATED_ROAD_TRIP)
            .international(UPDATED_INTERNATIONAL)
            .soloTravel(UPDATED_SOLO_TRAVEL);
        return tag;
    }
    ...
    void createTag() throws Exception {
        ...
        assertThat(testTag.getCamping()).isEqualTo(DEFAULT_CAMPING);
        assertThat(testTag.getHike()).isEqualTo(DEFAULT_HIKE);
        assertThat(testTag.getRoadTrip()).isEqualTo(DEFAULT_ROAD_TRIP);
        assertThat(testTag.getInternational()).isEqualTo(DEFAULT_INTERNATIONAL);
        assertThat(testTag.getSoloTravel()).isEqualTo(DEFAULT_SOLO_TRAVEL);
    }
    ...
    void getAllTags() throws Exception {
        ...
        restTagMockMvc
            ...
            .andExpect(jsonPath("$.[*].camping").value(hasItem(DEFAULT_CAMPING)))
            .andExpect(jsonPath("$.[*].hike").value(hasItem(DEFAULT_HIKE)))
            .andExpect(jsonPath("$.[*].roadTrip").value(hasItem(DEFAULT_ROAD_TRIP)))
            .andExpect(jsonPath("$.[*].international").value(hasItem(DEFAULT_INTERNATIONAL)))
            .andExpect(jsonPath("$.[*].soloTravel").value(hasItem(DEFAULT_SOLO_TRAVEL)));
    }
    ...
    void getTag() throws Exception {
        ...
        restTagMockMvc
            ...
            .andExpect(jsonPath("$.camping").value(DEFAULT_CAMPING))
            .andExpect(jsonPath("$.hike").value(DEFAULT_HIKE))
            .andExpect(jsonPath("$.roadTrip").value(DEFAULT_ROAD_TRIP))
            .andExpect(jsonPath("$.international").value(DEFAULT_INTERNATIONAL))
            .andExpect(jsonPath("$.soloTravel").value(DEFAULT_SOLO_TRAVEL));
    }
    ...
    void putExistingTag() throws Exception {
        ...
        Tag testTag = tagList.get(tagList.size() - 1);
        assertThat(testTag.getCamping()).isEqualTo(UPDATED_CAMPING);
        assertThat(testTag.getHike()).isEqualTo(UPDATED_HIKE);
        assertThat(testTag.getRoadTrip()).isEqualTo(UPDATED_ROAD_TRIP);
        assertThat(testTag.getInternational()).isEqualTo(UPDATED_INTERNATIONAL);
        assertThat(testTag.getSoloTravel()).isEqualTo(UPDATED_SOLO_TRAVEL);
    }
